...
if __name__ == "__main__":
    ...
    trials_psych_assess_map = {'cue_cti_stim_no_cue_400': '1', 'cue_cti_stim_double_cue_400': '2', 
                               'cue_cti_stim_valid_cue_400': '3', 'cue_cti_stim_invalid_cue_400': '4'}
    ...
    output_setting_one_comp.to_csv(f'/home/users/jmumford/efficiency/output/spatial_cueing_output_{filenum}.csv')
    with open(f'/home/users/jmumford/efficiency/output/spatial_cueing_events_{filenum}.pkl', 'wb') as f: 
