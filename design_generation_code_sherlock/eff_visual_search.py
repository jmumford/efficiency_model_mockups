...
if __name__ == "__main__":
    ...
    output_setting1.to_csv(f'/home/users/jmumford/efficiency/output/visual_search_output_{filenum}.csv')
    with open(f'/home/users/jmumford/efficiency/output/visual_search_events_{filenum}.pkl', 'wb') as f: 
