...
if __name__ == "__main__":
    ...
    output_delay_jitter_no_deriv.to_csv(f'/home/users/jmumford/efficiency/output/ax_cpt_output_{filenum}.csv')
    with open(f'/home/users/jmumford/efficiency/output/ax_cpt_events_{filenum}.pkl', 'wb') as f: 
