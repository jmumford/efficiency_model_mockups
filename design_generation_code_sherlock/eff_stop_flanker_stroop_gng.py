...
if __name__ == "__main__":
    ...
    if task == 'stop':
        ...
        output_setting1, events_setting1 = run_eff_sim(nsim, events_inputs, make_stop_flank_stroop_gng_timings, 
                               ...
                               trials_psych_assess_map, avg_prob_given_last1, avg_prob_given_last2, name_swap=name_swap)
        output_setting1.to_csv(f'/home/users/jmumford/efficiency/output/stop_signal_output_{filenum}.csv')
        with open(f'/home/users/jmumford/efficiency/output/stop_signal_events_{filenum}.pkl', 'wb') as f: 
    ...
    if task == 'flanker':
        ...
        avg_prob_given_last1, avg_prob_given_last2 = calc_avg_prob_next_given_last1_and_last2(unpermuted_trials)        
        nsim = 20000
        output_setting1, events_setting1 = run_eff_sim(nsim, events_inputs_flanker, make_stop_flank_stroop_gng_timings, 
                                    contrasts_flanker, avg_trial_repeats_info, tr, total_time,
                                    trials_psych_assess_map, avg_prob_given_last1, avg_prob_given_last2, name_swap=name_swap)
        output_setting1.to_csv(f'/home/users/jmumford/efficiency/output/flanker_stroop_output_{filenum}.csv')
        with open(f'/home/users/jmumford/efficiency/output/flanker_stroop_events_{filenum}.pkl', 'wb') as f: 
            pickle.dump(events_setting1, f)
    ...
    if task == 'gng':
        ...
        avg_prob_given_last1, avg_prob_given_last2 = calc_avg_prob_next_given_last1_and_last2(unpermuted_trials)
        nsim = 20000
        output_setting1, events_setting1= run_eff_sim(nsim, events_inputs_gng, make_stop_flank_stroop_gng_timings, 
                                    contrasts_gng, avg_trial_repeats_info, tr, total_time,
                                    trials_psych_assess_map, avg_prob_given_last1, avg_prob_given_last2, name_swap=name_swap)
        output_setting1.to_csv(f'/home/users/jmumford/efficiency/output/gng_output_{filenum}.csv')
        with open(f'/home/users/jmumford/efficiency/output/gng_events_{filenum}.pkl', 'wb') as f: 
            pickle.dump(events_setting1, f)
